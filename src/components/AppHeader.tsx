  ...
  return (
    <header className="glass-card mx-3 sm:mx-4 mt-[env(safe-area-inset-top,16px)] sm:mt-4 mb-4 sm:mb-6 px-3 sm:px-6 py-3 sm:py-4 flex items-center justify-between sticky top-0 z-40 bg-card/95 backdrop-blur-md">
      <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
        <img
          src="/ipi-logo.jpg"
          alt="Irrigation Products International Pvt Ltd"
          className="h-10 w-10 rounded-md object-contain bg-white p-1 border border-border flex-shrink-0"
        />
        <div className="min-w-0">
          <h1 className="text-sm sm:text-lg font-bold text-foreground truncate">Irrigation Products International Pvt Ltd</h1>
          <p className="text-xs sm:text-sm text-muted-foreground truncate">
            <span className="font-medium text-foreground">{user?.name}</span>
            <span className="hidden md:inline"> • Claims Management System</span>

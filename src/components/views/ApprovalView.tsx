  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <ResponsiveOverlay
        ...
        title={`Admin Review - ${adminReviewDraft?.claimId || adminReviewModal?.claimId || ''}`}
      ...
      <ResponsiveOverlay
        ...
        title={`${managerReviewMode ? 'Final Review' : 'Claim Details'} - ${viewClaim?.claimId || managerReviewClaimId || ''}`}
